...
- (void)setupSubViews {
    ...
    self.chatTable.frame = CGRectMake(0, 0, SCREEN_WIDTH, 564);
    ...
    self.inputText.frame = CGRectMake(20, 569, SCREEN_WIDTH-40, 40);
...
- (void)updataFrame {
    self.chatTable.frame = CGRectMake(0, 0, SCREEN_WIDTH, 564 - self.keyboardHeight);
    self.inputText.frame = CGRectMake(10, 569 - self.keyboardHeight , SCREEN_WIDTH-20, 40);
    [self tableViewScrollToBottom];
}
